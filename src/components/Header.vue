        ...
        >
          <div class="flex items-center flex-1">
            <div class="flex items-center justify-between w-full md:w-auto">
              <a href="/">
                <span class="sr-only">Arquatics</span>
                <img
                  class="rounded w-auto h-24"
            ...
            >
              <div class="lg:py-24">
                ...
                <h1
                  ...
                  "
                >
                  <span class="block text-5xl">A better Experience of</span>
                  <span
                    class="
                      block
                      text-transparent
                ...
                >
                  ...
                  Magnam corrupti enim est? Vitae vel maxime eius repudiandae
                  aliquid saepe ipsa consequuntur modi, est totam fuga omnis
                  nobis libero odit voluptate.
                </p>
                <div class="mt-10 sm:mt-12">
                  <a href="collection" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                    <div class="sm:flex">
                      <div class="min-w-0 flex-1 webkit-center">
